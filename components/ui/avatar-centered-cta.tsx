        ...
        <form onSubmit={handleSubmit} className="mt-8 w-full max-w-md space-y-4">
          <div>
            <Input
              ...
              className="h-12 rounded-xl border-[var(--color-muted-subtle)] bg-[var(--color-background-site)] px-4 text-lg focus:border-[var(--color-primary-brand)] focus:ring-[var(--color-primary-brand)]"
              required
            />
          </div>
